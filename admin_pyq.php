...
<center>
    ...
    <head>
        <title>
            Insert previous year question papers
        </title>
    </head>

    <body>
        <form action='pyq_insertion.php' method=POST>
            <h1> INSERT-PREVIOUS-YEAR-PAPERS </h1>
            <hr>
            <br>
            <table border=1>
                <tr>
                ...
                <tr>
                    <td>MONTH</td>
                    <td><input type=text name=month required=yes></input></td>
                </tr>
                <tr>
                    <td>YEAR</td>
                    <td><input type=text name=year required=yes></input></td>
                </tr>
                <tr>
                    <td>TEST PAPER LINK</td>
                    <td><input type=text name=test_paper required=yes></input></td>
                </tr>
            </table>
            <br>
            <br>
